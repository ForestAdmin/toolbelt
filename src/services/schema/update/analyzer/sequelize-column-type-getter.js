...
function ColumnTypeGetter(databaseConnection, schema, allowWarning = true) {
  ...
  this.perform = async (columnInfo, columnName, tableName) => {
    ...
    switch (type) {
      ...
      default:
        if (allowWarning) {
          logger.warn(`Type ${chalk.bold(type)} is not handled: The column ${chalk.bold(columnName)} won't be generated by Forest CLI. If you need it please create it manually.`);
        }
        return null;
    }
  };

module.exports = {
  ...
  HINT_MISSING_PROJECT_NAME:
    'Please specify a project name. Type "forest help for" more information.',
  ERROR_NOT_PARSABLE_CONNECTION_URL:
    'Cannot parse the database dialect. Please, check the syntax of the database connection string.',

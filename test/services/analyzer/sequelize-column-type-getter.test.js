...
describe('services > column type getter', () => {
  ...
  describe('using postgresql', () => {
    ...
    it('should not handle MONEY type', async () => {
      ...
      // expect(warnSpy).toHaveBeenCalledWith("Type MONEY is not handled: The column paying won't be generated by Forest CLI. If you need it please create it manually.");

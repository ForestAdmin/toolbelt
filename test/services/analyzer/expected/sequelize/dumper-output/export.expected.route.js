...
const { modelExport } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('modelExport');

// This file contains the logic of every route in Forest Admin for the collection modelExport:
...
// Create a Export
router.post('/modelExport', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Export
router.put('/modelExport/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Export
router.delete('/modelExport/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/modelExport', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Export a list of Exports
router.get('/modelExport.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/modelExport', permissionMiddlewareCreator.delete(), (request, response, next) => {

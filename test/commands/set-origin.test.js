...
describe('set origin', () => {
  describe('when no project was provided', () => {
    ...
    it('should display the list of projects', () =>
      testCli({
        ...
        std: [{ out: '√ Origin "name1" successfully set.' }],
      }));
  });

  describe('when no argument was provided', () => {
    it('should display the list of available environments', () =>
      testCli({
        ...
        std: [{ out: '√ Origin "Production" successfully set.' }],
      }));
  });
  ...
  describe('when argument environment was provided', () => {
    it('should work as expected', () =>
      testCli({
        ...
        api: [() => getProjectByEnv(), () => setOriginValid('Production')],
        prompts: [],
        std: [{ out: '√ Origin "Production" successfully set.' }],
      }));
  });
  ...
  describe('when backend throw an error', () => {
    it('should prompt the error', () =>
      testCli({
        env: testEnvWithSecret,
        token: 'any',
        commandClass: SetOriginCommand,
        commandArgs: ['unknownEnv'],
        api: [() => getProjectByEnv(), () => setOriginInValid('unknownEnv')],
        prompts: [],
        std: [{ err: '× Set origin error' }],
        exitCode: 2,
      }));
  });
});

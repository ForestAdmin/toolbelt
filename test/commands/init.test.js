...
describe('init command', () => {
    ...
    describe('when the user has no project', () => {
      it('should stop executing with a custom message', () =>
        testCli({
          ...
          env: noKeyEnv,
          token: 'any',
          api: [() => getProjectListEmpty()],
          std: [{ err: "× You don't have any project yet." }],
          exitCode: 1,
        }));
    });

    describe('when the user has only one project', () => {
      it('should continue executing', () =>
        testCli({
          commandClass: InitCommand,
          env: noKeyEnv,
          token: 'any',
    ...
    describe('when the user explicitely specify an invalid project', () => {
      it('should stop executing with a custom message', () =>
        testCli({
          ...
          env: noKeyEnv,
          token: 'any',
          api: [() => getProjectNotFoundForDevWorkflow()],
          std: [{ err: '× The project you specified does not exist.' }],
          exitCode: 1,
        }));
    });
    ...
    describe('when the user has no admin rights on the given project', () => {
      it('should stop executing with a custom error message', () =>
        testCli({
          ...
          env: testEnvWithSecret,
          token: 'any',
          api: [() => getProjectByEnvIncludeLegacy(), () => getProjectForDevWorkflowUnallowed(82)],
          std: [
            { spinner: '√ Selecting your project' },
            { spinner: '× Analyzing your setup' },
            {
    ...
    describe('when the project is still flagged as v1', () => {
      it('should stop executing with a custom error message', () =>
        testCli({
          ...
          env: testEnvWithSecret,
          token: 'any',
          api: [() => getProjectByEnvIncludeLegacy(), () => getV1ProjectForDevWorkflow(82)],
          std: [
            { spinner: '√ Selecting your project' },
            { spinner: '× Analyzing your setup' },
            {
    ...
    describe('when the project has no prod or remote', () => {
      it('should stop executing with a custom error message', () =>
        testCli({
          ...
          env: testEnvWithSecret,
          token: 'any',
          api: [() => getProjectByEnvIncludeLegacy(), () => getNoProdProjectForDevWorkflow(82)],
          std: [
            { spinner: '√ Selecting your project' },
            { spinner: '× Analyzing your setup' },
            {
  ...
  describe('database setup', () => {
    describe('when the project has an in-app origin', () => {
      it('should go to backend endpoint setup', () =>
        testCli({
          commandClass: InitCommand,
          env: testEnvWithSecret,
          token: 'any',
    ...
    describe('when the project has a ForestCLI (Lumber) origin', () => {
      ...
      describe('when the project .env file has no database url in it', () => {
        describe('when the user answer positively to specify its credentials', () => {
          it('should display a database detail input and prompt the database credentials as env variables', () =>
            testCli({
              files: [
                {
                  name: '.env',
        ...
        describe('when the user answer negatively to specify its credentials', () => {
          it('should go to the backend endpoint setup without database credentials as env variables', () =>
            testCli({
              files: [
                {
                  name: '.env',
  ...
  describe('environment variables', () => {
    describe('when the project is NOT flagged as in-app and has a .env file', () => {
      it('should copy the env variable in the .env file', () =>
        testCli({
          files: [
            {
              name: '.env',
    ...
    describe('when the project is NOT flagged as in-app and does not have a .env file', () => {
      it('should ask if the user wants to create an env file and if not, displays the environment variables', () =>
        testCli({
          commandClass: InitCommand,
          env: testEnvWithSecretAndDatabaseURL,
          token: 'any',
      ...
      it('should ask if the user wants to create an env file and if yes, create it', () =>
        testCli({
          commandClass: InitCommand,
          env: testEnvWithSecretAndDatabaseURL,
          token: 'any',
